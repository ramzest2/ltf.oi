...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.Telegram && window.Telegram.WebApp) {
        ...
        function displayQRCode(qrUrl, expiryTime) {
            ...
            // Напрямую используем URL от Midtrans
            ...
            qrImage.onerror = function() {
                ...
                tg.showAlert('Ошибка при загрузке QR-кода. Попробуйте еще раз.');
            };
            
            qrImage.onload = function() {
                console.log('QR-код успешно загружен');
                // Показываем контейнер только после успешной загрузки
