...
function playAudio(arrayBuffer) {
    ...
    try {
        ...
        if (!isWav) {
            console.error('Полученные данные не являются WAV-файлом');
            return;
        }
        ...
        audioContext.decodeAudioData(arrayBuffer, 
            ...
            (error) => {
                ...
                tg.showAlert('Произошла ошибка при декодировании аудио. Пожалуйста, попробуйте еще раз.');
            }
        );
    } catch (error) {
        console.error('Ошибка при обработке аудио:', error);
        tg.showAlert('Произошла ошибка при обработке аудио. Пожалуйста, попробуйте еще раз.');
    }
}
